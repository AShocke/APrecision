...
public:
	...
	// decimal_point is an  integer denoting the place of the decimal point or 0 if it is at the begining of the
	// number (eg. 0.356 decimal_point = 0, 0.00356 decimal_point = -2)
